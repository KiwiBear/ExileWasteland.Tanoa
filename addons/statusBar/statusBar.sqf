...
//	systemChat format["StatusBar Initialized", _rscLayer];
	[] spawn 
	{
		...
		_colour108		= parseText "#ffffff";
		_colour107		= parseText "#ffffff";
		_colour106		= parseText "#ffffff";
		_colour105		= parseText "#ffffff";
		_colour104		= parseText "#ffffff";
		_colour103		= parseText	"#ffffff";
		_colour102		= parseText "#ffffff";
		_colour101		= parseText "#ffffff";
		_colour100 		= parseText "#ffffff";
		_colour90 		= parseText "#ffffff";
		_colour80 		= parseText "#ffffff";
		_colour70 		= parseText "#ffffff";
		_colour60 		= parseText "#ffffff";
		_colour50 		= parseText "#ffffff";
		_colour40 		= parseText "#ffffff";
		_colour30 		= parseText "#ffffff";
		_colour20 		= parseText "#ffffff";
		_colour10 		= parseText "#ffffff";
		_colour0 		= parseText "#ffffff";
		_colourDead 	= parseText "#ffffff";
		...
		switch(_minutes) do
	{
		...
		((uiNamespace getVariable "osefStatusBarAdmin")displayCtrl 55554)ctrlSetStructuredText parseText 
			format["
			<t shadow='1' shadowColor='#000000' color='%10'><img size='1.0'  shadowColor='#000000' image='addons\statusbar\icons\players.paa' color='%10'/> %2</t>
			...
			<t shadow='1' shadowColor='#000000' color='%10'><img size='1.0'  shadowColor='#000000' image='addons\statusbar\icons\tabs.paa' color='%10'/> %4</t> 
			...
			<t shadow='1' shadowColor='#000000' color='%15'><img size='1.0'  shadowColor='#000000' image='addons\statusbar\icons\rep.paa' color='%10'/> %9</t> 
