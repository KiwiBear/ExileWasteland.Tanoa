...
// Custom Loadout Starts Here. Uncomment the lines you want your players to have..
	...
	// Clothing
	_bambiPlayer forceAddUniform "U_I_C_Soldier_Bandit_2_F"; // Black Exile Overalls
	_bambiPlayer addVest "V_BandollierB_blk"; // Change Vest Class Here
	_bambiPlayer addHeadgear "H_Cap_usblack"; // Change Headgear Class Here
